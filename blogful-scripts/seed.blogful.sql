...
VALUES 
    ('Boots''s life', now() - '29 days'::INTERVAL, 'I chase frisbees, balls and sticks, eat all the kibble and sleep the rest of the day'),
    ('Man of action', now() - '10 days'::INTERVAL, 'Craig does all the chores before they are due.'),
    ('Life on the Quaran-Team', now() - '1 days'::INTERVAL, 'I have no excuse for not getting my homework done'),
    ('Boots', now() - '375 days'::INTERVAL, 'A scrappy little blue dog!'),
    ('Northeast', '2016-01-16 12:00:00',       'Despotato Despotat0Despotatoo'),
    ('Midwest ',  '2016-05-01 15:00:00',       'Shape of Pooh Despotato'),
